...
//                            }),
        ...
        mounted(){
            this.getBirthData('All','新三板上市公司[管理层]的年龄分布','#c23531',2000,120000);
            this.getBirthData('Director','新三板上市公司[董事]的年龄分布','rgb(42,128,185)',500,40000);
            this.getBirthData('President','新三板上市公司[总裁]的年龄分布','rgb(243,156,17)',10,12000);
            this.getBirthData('Manager','新三板上市公司[经理]的年龄分布','rgb(45,62,80)',20,20000);
            this.getBirthData('Zongjian','新三板上市公司[总监]的年龄分布','rgb(22,160,134)',10,6000);
            this.getBirthData('Supervisor','新三板上市公司[监事]的年龄分布','rgb(143,68,173)',500,30000);
        },
        methods: {
            // type 获取的title类型
            // 图表标题
